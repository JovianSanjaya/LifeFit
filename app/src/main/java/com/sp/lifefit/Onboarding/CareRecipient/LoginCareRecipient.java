...
public class LoginCareRecipient extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        donthaveacc.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(LoginCareRecipient.this, SignUpCareRecipient.class);
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()){
                    ...
                    if(Objects.equals(passwordFromDB,userPassword)){
                        loginemail.setError(null);
                        Intent intent =new Intent(LoginCareRecipient.this, MainCareRecipient.class);
                        startActivity(intent);
                    }
                    else {
